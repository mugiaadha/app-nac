...
export class BrevetDetailComponent implements OnInit {
  ...
  private programs: BrevetProgram[] = [
    {
      ...
      description: 'Program pelatihan dasar perpajakan untuk pemahaman fundamental sistem pajak Indonesia. Cocok untuk pemula yang ingin memahami dasar-dasar perpajakan.',
      duration: '40 Jam',
      modules: 8,
      level: 'Beginner',
      color: 'text-primary',
    ...
    },
    {
      ...
      description: 'Program pelatihan perpajakan tingkat menengah untuk praktisi dan konsultan pajak. Mengembangkan keahlian perpajakan yang lebih mendalam.',
      duration: '60 Jam',
      modules: 12,
      level: 'Intermediate',
      color: 'text-success',
    ...
    },
    {
      ...
      description: 'Program pelatihan perpajakan tingkat lanjut untuk menjadi konsultan pajak bersertifikat. Persiapan untuk ujian konsultan pajak.',
      duration: '80 Jam',
      modules: 16,
      level: 'Advanced',
      color: 'text-warning',
  ...
  enrollNow() {
    ...
    this.router.navigate(['/course-learning', `brevet-${this.programId}`]);
  }

  downloadBrochure() {
    console.log(`Downloading brochure for Brevet ${this.programId.toUpperCase()}`);
